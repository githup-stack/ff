    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Chúng tôi cung cấp những món ăn ngon nhất với chất lượng cao và
              giá cả hợp lý. Sứ mệnh của chúng tôi là mang đến trải nghiệm ẩm
              thực tuyệt vời cho mọi khách hàng.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>© {currentYear} Restaurant App. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
